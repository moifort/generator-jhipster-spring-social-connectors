...
var jhipsterVar = {moduleName: 'spring-social-connectors'};
...
module.exports = yeoman.generators.Base.extend({
    ...
    prompting: function () {
        ...
        this.log(yosay(
            'Welcome to the ' + chalk.red('JHipster Spring social connectors') + ' generator!'
        ));
    ...
    writing: function () {
        ...
        jhipsterFunc.addBowerDependency('spring-social-connectors', '0.5.6');
